...
Traceback (most recent call last):
  File "<pyshell#3>", line 1, in <module>
    phoneRegex = re.compile(r' (\d\d\d-)?\d\d\d-\d\d\d\d(,)?){3}')
  File "/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/re.py", line 252, in compile
    return _compile(pattern, flags)
  File "/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/re.py", line 304, in _compile
    p = sre_compile.compile(pattern, flags)
  File "/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/sre_compile.py", line 764, in compile
    p = sre_parse.parse(p, flags)
  File "/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/sre_parse.py", line 962, in parse
    raise source.error("unbalanced parenthesis")
re.error: unbalanced parenthesis at position 30
>>> phoneRegex = re.compile(r'((\d\d\d-)?\d\d\d-\d\d\d\d(,)?){3}')
...
>>> rj = '''The Project Gutenberg EBook of Romeo and Juliet, by William Shakespeare
...
>>> phoneRegex.search(rj)
>>> phoneRegex.findall(rj)
[]
...
>>> doubleVowelRegex.findall(lyrics)
['ea', 'ie', 'ai', 'ee', 'ea', 'ee']
>>> 
>>> 
>>> 
...
>>> vowelRegex.findall(lyrics)
['1', '2', ' ', 'D', 'r', 'm', 'm', 'r', 's', ' ', 'D', 'r', 'm', 'm', 'n', 'g', ',', ' ', '1', '1', ' ', 'P', 'p', 'r', 's', ' ', 'P', 'p', 'n', 'g', ',', ' ', '1', '0', ' ', 'L', 'r', 'd', 's', ' ', ' ', 'L', 'p', 'n', 'g', ',', ' ', '9', ' ', 'L', 'd', 's', ' ', 'D', 'n', 'c', 'n', 'g', ',', ' ', '8', ' ', 'M', 'd', 's', ' ', ' ', 'M', 'l', 'k', 'n', 'g', ',', ' ', '7', ' ', 'S', 'w', 'n', 's', ' ', ' ', 'S', 'w', 'm', 'm', 'n', 'g', ',', ' ', '6', ' ', 'G', 's', ' ', ' ', 'L', 'y', 'n', 'g', ',', ' ', '5', ' ', 'G', 'l', 'd', 'n', ' ', 'R', 'n', 'g', 's', ',', ' ', '4', ' ', 'C', 'l', 'l', 'n', 'g', ' ', 'B', 'r', 'd', 's', ',', ' ', '3', ' ', 'F', 'r', 'n', 'c', 'h', ' ', 'H', 'n', 's', ',', ' ', '2', ' ', 'T', 'r', 't', 'l', ' ', 'D', 'v', 's', ',', ' ', 'n', 'd', ' ', '1', ' ', 'P', 'r', 't', 'r', 'd', 'g', ' ', 'n', ' ', ' ', 'P', 'r', ' ', 'T', 'r']
>>>

# regex method findall() is passed a string and returns all matches not just first match
# if regex has 0 or 1 group find all returns a list of strings
# regex has 2 or more groups
# findall() returns a list of tuples of strings
# \d is shorthand for character class that matches digits
# \w matches word characters \ s matches whitespace characters
# uppercase shorthand classes matches characters that are not digits, word characters, or spaces \D \W \S
# you can make your own character classes with square brackets: [aeiou]
# a ^ caret makes it a negative character class matching anything not in brackets
